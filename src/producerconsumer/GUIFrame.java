...
public class GUIFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(numberProducers > 0 && numberConsumers > 0 && bufferSize > 0){
              //Inicializar clase productor consumidor
              ProducerConsumer producerConsumer = new ProducerConsumer(numberProducers,numberConsumers,bufferSize);
         }else{
            // Cambiar recuadro a rojo y mostrar error
 
        }
        
        /*
        
        System.out.println("Número de productores: " + numberProducers);
        System.out.println("Número de consumidores: " + numberConsumers);
